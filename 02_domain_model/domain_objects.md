...
| Deployment | `deploymentId`, `applicationId`, `environment`, `deploymentTarget`, `status`, `createdAt`, `updatedAt` | Một lần triển khai application cụ thể. Đây là lifecycle aggregate giữ context, actual workload images và record theo dõi. | **Deployment** (aggregate root) |
