...
| UC-02 Configuration page, navigation, binding fields and Review | [`ConfigurationPage.tsx`](../../idp/frontend/src/features/environment-configuration/pages/ConfigurationPage.tsx), [`useConfigurationDraft.ts`](../../idp/frontend/src/features/environment-configuration/hooks/useConfigurationDraft.ts), [`BindingField.tsx`](../../idp/frontend/src/features/environment-configuration/components/BindingField.tsx), [`ConfigurationNavigation.tsx`](../../idp/frontend/src/features/environment-configuration/components/ConfigurationNavigation.tsx) |
| UC-02 client-owned draft, sessionStorage and local validation | [`draft`](../../idp/frontend/src/features/environment-configuration/draft/) |
| UC-02 Environment Configuration API and Service | [`configuration.go`](../../idp/backend/internal/web/configuration.go), [`internal/service/configuration.go`](../../idp/backend/internal/service/configuration.go) |
| UC-02 validation and compare-and-write save | [`configvalidator`](../../idp/backend/internal/domain/configvalidator/), [`environment_configuration_repository.go`](../../idp/backend/internal/persistence/environment_configuration_repository.go) |
