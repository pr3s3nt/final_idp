...
for app in backend frontend worker; do
  for tag in v1 v2 broken; do
    ...
    CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -trimpath \
      -ldflags "-s -w -X github.com/pr3s3nt/final_idp/uc03/demo-apps/internal/common.Version=$version -X github.com/pr3s3nt/final_idp/uc03/demo-apps/internal/common.Broken=$broken" \
